...
import { useSettings } from "@/features/teacher/hooks/useSettings";
...
/**
 * "Settings" sidebar entry — new page + new TeacherSidebar.tsx link
 * (previously Teacher had no Settings entry at all, unlike Parent's
 * pre-existing dead link). Same shape as `/parent/settings` — see
 * that page's comment.
 */
