...
/**
 * "Complain" sidebar entry — previously a dead link
 * (`ParentSidebar.tsx`). A Parent raises a support issue with a
 * subject + description; it's OPEN until Admin responds
 * (`/admin/complaints`) — single-step, Admin only, same shape as
 * `/teacher/leave`. See `complaint.service.ts`.
 */
...
export default function ParentComplainPage() {
  const { complaints, loading, error, submitting, submit } = useParentComplaints();
  ...
  return (
    <div className="p-4 sm:p-8 max-w-2xl mx-auto">
      <div className="mb-6">
        <p className="text-sm font-bold uppercase tracking-wider text-brand">Support</p>
